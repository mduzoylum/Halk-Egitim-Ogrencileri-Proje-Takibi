...
--
-- Anamakine: 127.0.0.1
-- Üretim Zamanı: 07 Ara 2017, 18:25:19
...
('root', '[{\"db\":\"sanayimnet\",\"table\":\"kullanicib\"},{\"db\":\"sanayimnet\",\"table\":\"kullanici-bilgileri\"},{\"db\":\"sanayimnet\",\"table\":\"sad\"},{\"db\":\"sanayimnet\",\"table\":\"sahis_bilgileri\"},{\"db\":\"test\",\"table\":\"istatistik\"},{\"db\":\"test\",\"table\":\"sektor_bilgileri\"},{\"db\":\"test\",\"table\":\"sirket_sektorleri\"},{\"db\":\"test\",\"table\":\"urun_bilgileri\"},{\"db\":\"sanayimnet\",\"table\":\"id\"}]');
...
('root', '2017-12-03 17:11:10', '{\"lang\":\"tr\",\"collation_connection\":\"utf8mb4_unicode_ci\"}');
...
ALTER TABLE `pma__savedsearches`
  MODIFY `id` int(5) UNSIGNED NOT NULL AUTO_INCREMENT;
--
-- Veritabanı: `sanayimnet`
--
CREATE DATABASE IF NOT EXISTS `sanayimnet` DEFAULT CHARACTER SET utf8 COLLATE utf8_turkish_ci;
USE `sanayimnet`;

-- --------------------------------------------------------

--
-- Tablo için tablo yapısı `kullanicib`
--

CREATE TABLE `kullanicib` (
  `id` int(11) NOT NULL,
...
--
-- Tablo döküm verisi `kullanicib`
--

INSERT INTO `kullanicib` (`id`, `isim`, `kullaniciadi`, `sifre`) VALUES
(1, 'Tarık', 'tarik', 'tarik123');
--
-- Veritabanı: `test`
--
